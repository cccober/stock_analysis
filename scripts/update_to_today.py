...
def update_to_today(target_prices=None):
    """
    将所有股票数据更新到今天
    
    如果提供了目标价格，生成的数据会逐步收敛到目标价格
    """
    ...
    try:
        ...
        for idx, row in stocks_df.iterrows():
            ...
            # 检查是否有目标价格
            target_price = None
            if target_prices and ts_code in target_prices:
...
if __name__ == "__main__":
    # 使用目标价格更新
    update_to_today(target_prices=TARGET_PRICES)
